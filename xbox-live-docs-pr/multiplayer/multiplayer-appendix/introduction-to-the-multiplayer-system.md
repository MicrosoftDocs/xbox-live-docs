...
For details of Multiplayer use of this service, see [Matchmaking](../matchmaking/matchmaking.md).
...
| Match Target Session                 | A match session set up during SmartMatch matchmaking to represent the match. See [Matchmaking](../matchmaking/matchmaking.md).                                                                                                                                                                                                                                                                                                                                                                                              |
| Match Ticket Session                 | A preliminary match session set up during SmartMatch matchmaking. See [Matchmaking](../matchmaking/matchmaking.md).                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| SmartMatch Matchmaking               | An Xbox Live matchmaking capability available to Xbox One titles, implemented by the matchmaking service. Using MPSD and matchmaking, the title makes a request to be matched and is notified later that a matched group has been found. See [Matchmaking](../matchmaking/matchmaking.md).                                                                                                                                                                                                                                  |
