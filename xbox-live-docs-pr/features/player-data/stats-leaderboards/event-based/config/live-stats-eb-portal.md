...
For an intro to the event-based Data platform, see [How the event-based player data platform works](../live-how-data-platform-works.md).
...
See also:
* [Event-based Stats & Leaderboards](../live-statslb-eb-nav.md)
