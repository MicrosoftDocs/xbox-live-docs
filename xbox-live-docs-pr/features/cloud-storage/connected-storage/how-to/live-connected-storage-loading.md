...
These changes are further detailed in the Connected Storage Section of [Porting Xbox Live code from XDK to UWP](../../../../test-release/live-port-xbl-code-from-xdk-to-uwp.md).
