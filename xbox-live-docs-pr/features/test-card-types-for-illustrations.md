...
<h1>Test: Card types for illustrations</h1>
...
<h2>cardsK+style - no border, normal text size</h2>
...
<h2>cardsK - no border, normal text size</h2>
<ul class="cardsK panelContent cols cols2">
    <li>
        <a href="/gaming/xbox-live/features/identity">
            <div class="cardSize">
...
<h2>cardsW - no border, big text, 1" top padding</h2>
...
<h2>cardsC - large bottom padding</h2>
