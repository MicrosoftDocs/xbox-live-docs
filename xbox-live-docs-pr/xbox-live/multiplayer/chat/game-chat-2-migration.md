...
For more details, see [Accessibility](#accessibilityGame Chat then generates a chat packet containing this message.
...
The original Game Chat is a WinRT API; thus, it reported errors through exceptions.
