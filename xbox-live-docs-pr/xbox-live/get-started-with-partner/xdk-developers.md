---
title: Get started with Visual Studio for XDK-based games
...
# Get started with Visual Studio for XDK-based games
...
Get started with Visual Studio for XDK-based games| [Where to get the XDK](where-to-get-xdk.md) | Obtaining the Xbox Developer Kit (XDK). |
