...
author: KevinAsgari
description: Getting started with Xbox Live development as a managed partner or ID@Xbox member.
...
This section covers getting started with Xbox Live development as a managed partner or as an ID@Xbox developer. Partners and ID developers can access the full range of Xbox Live features, including achievements, multiplayer, and more.
