...
## [Get started with the Xbox Live APIs on Win32](get-started-with-win32-ios-android/win32-get-started-with-xsapi.md)
## [Get started with the Xbox Live APIs on  Android](get-started-with-win32-ios-android/android-get-started-with-xsapi.md)
## [Get started with the Xbox Live APIs on iOS](get-started-with-win32-ios-android/ios-get-started-with-xsapi.md)
...
### [TEMP Xbox Authentication Layer (XAL)](using-xbox-live/auth/xal.md)
#### [TEMP XAL Sign-in scenarios](using-xbox-live/auth/xal-sign-in.md)
#### [TEMP XAL on Win32](using-xbox-live/auth/win32-xal.md)
#### [TEMP XAL on Android](using-xbox-live/auth/android-xal.md)
#### [TEMP XAL on iOS](using-xbox-live/auth/iOS-xal.md)
