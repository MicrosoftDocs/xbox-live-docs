...
| Global             | 256 MB | 256 MB            | Data that everyone can read, such as rosters, maps, challenges, or art resources. | Only writeable via Partner Center, any platform may read.                                | All users may read.
