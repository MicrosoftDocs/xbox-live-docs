...
![add new reference in VS](live-develop-creators-title-vstudio-images/get-started-vs-add-ref.png)
...
![add new reference in VS](live-develop-creators-title-vstudio-images/get-started-vs-add-capability.png)
