...
* [Joining the ID@Xbox Program](../join-dev-program/live-join-id-program.md).
...
1. Go to <a href="https://partner.microsoft.com/dashboard/" target="_blank">Partner Center</a>.
   ...
   ![The "Overview" page at Partner Center](live-setup-partner-center-partners-images/pc_overview_pg.png)

2. Click the **Create a new...** button.

   The page "Create your app by reserving a name" appears.

   ![The "Create your app by reserving a name" page](live-setup-partner-center-partners-images/pc_createappreservename.png)
...
4. Click the check box **Create this product in a sandbox**.
   ...
   ![The "Create this product in a sandbox" option button](live-setup-partner-center-partners-images/pc_createappreservename02.png)

5. Click the **Reserve product name** button.

   The "App overview" page appears.

   ![The "App overview" page](live-setup-partner-center-partners-images/pc_app_overview01_pg.png)

6. Click the **Start your submission** button.

   The "Start your submission" dialog box appears.

   ![The "Start your submission" dialog box](live-setup-partner-center-partners-images/pc_startyoursubmission_dbx.png)
...
2. Click **App management**: **App identity**.
   ...
   ![The "Identity details" page](live-setup-partner-center-partners-images/pc_identitydetails_pg.png)
...
2. Click **Products**, and then click your game.
   ...
   ![The "App overview" page](live-setup-partner-center-partners-images/pc_app_overview_pg.png)

3. Under **Services**, click **Xbox Live**.

   The "Enable Xbox Live" page appears, this first time only.

   ![The "Enable Xbox Live" page](live-setup-partner-center-partners-images/pc_enablexboxlive_pg.png)
...
5. Click the **Enable** button.  
   ...
   ![The "Gameplay Setting" page](live-setup-partner-center-partners-images/pc_gameplay_setting_pg.png)
...
1. In Partner Center, click **Products** on the left, and then click the product you created.
   ...
   ![The "App overview" page](live-setup-partner-center-partners-images/pc_app_overview_02_pg.png)

1. Click the **Settings** gear in the upper right, then click **Developer settings**.

   The "Account settings" page appears.

   ![The "Account settings" page](live-setup-partner-center-partners-images/pc_account_settings_pg.png)

1. In the **Settings** area in the middle, click **Xbox Live**: **Xbox test accounts**.

   ![The "Settings: Xbox Live" menu](live-setup-partner-center-partners-images/pc_account_settings_pg_xblmenu.png)

   The "Manage test accounts" page appears.

   ![The "Manage test accounts" page](live-setup-partner-center-partners-images/pc_manage_test_accounts_pg.png)

1. Click the **New test account** button.

   The "New test accounts" page appears.

   ![The "New test accounts" page](live-setup-partner-center-partners-images/pc_new_test_accounts_pg.png)
...
1. Click the **Save** button.
   ...
   ![The "Manage test accounts" page with new test accounts](live-setup-partner-center-partners-images/pc_manage_test_accounts_pg_newaccts.png)

1. Under the **New test account** button, click the **View job history** link.  

    The "Job History" dialog box appears.  

   ![The "Job History" dialog box](live-setup-partner-center-partners-images/pc_job_history_dbx.png)
