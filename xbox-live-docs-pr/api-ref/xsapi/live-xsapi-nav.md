...
| Article | Description |
|---------|-------------|
| [Introduction to Xbox Live APIs](../../api-ref/xsapi/live-introduction-to-xbox-live-apis.md) | Xbox Live services can be called through client-side XSAPI (WinRT, C++11, or C) or through REST endpoints. |
| [Xbox Live Samples](../../api-ref/live-samples.md) | There are Xbox Live API samples and Xbox Developer Kit samples. |
| [Introduction to Xbox Live C APIs](../../api-ref/xsapi/live-xsapi-flat-c.md) | XSAPI's C API for the Xbox Live service. |
